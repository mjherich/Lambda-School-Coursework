...
export default function Pagination({dataArray, render:Data}) {
  ...
  return (
    <div className="container">
      ...
      <Data paginatedData={paginatedData} handleShowCount={handleShowCount}/>
      <PaginationHandler 
...
function PaginationHandler(props){
    ...
    return (
        <nav>
            ...
            {(currentPage != 1) 
                ? <li className="page-item" ><a onClick={function onPageLastClick(){
                    return handleFirst(currentPage)
                }} className="page-link">{"First"}</a></li>
                : null
                }
            <li className="page-item" ><a onClick={function onPagePrevClick(){
                ...
                {pages.map(function renderPageCount(page, index) {
                    return (
                        ...
                        <li className={page == currentPage ? "page-item active":"page-item"}>
                            <a onClick={function onPageClick(){
                ...
                <li className="page-item" ><a onClick={function onPageNextClick(){
